...
if __name__ == '__main__':
    ...
    data0 = [random.randint(1, 100) for _ in range(100_000_000)]
    data1 = [random.randint(100, 500) for _ in range(100_000_000)]
    data2 = [random.randint(500, 1000) for _ in range(100_000_000)]
    data2 = [random.randint(500, 1000) for _ in range(100_000_000)]
